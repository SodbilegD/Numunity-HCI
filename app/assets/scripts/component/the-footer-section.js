class TheFooterSection extends HTMLElement {
    constructor() {
        super();
        this.#render();
        //implementation
    ...
    #render(){
        ...
        <div class="footer__nav">
            ...
            <ul>
                ...
                <li><a href="selectedcommunity.html"><i class="fa-solid fa-user"></i>Community</a></li>
            </ul>
        </div>
...
window.customElements.define('the-footer-section', TheFooterSection);